...
describe PowerOnSnackTest do
  ...
  it "displays a list of the latest headlines" do
    ...
    expect(last_response.body).to match(/<li class="triggered"><span class="timestamp">Tue  3 Feb 16:34:41 [A-Z]+<\/span><a href="http:\/\/www.bbc.co.uk\/news\/uk-politics-31099106#sa-ns_mchannel=rss&ns_source=PublicRSS20-sa/)
    expect(last_response.body).to match(/<li class="normal"><span class="timestamp">Tue  3 Feb 16:19:37 [A-Z]+<\/span><a href="http:\/\/www.bbc.co.uk\/news\/health-31069173#sa-ns_mchannel=rss&ns_source=PublicRSS20-sa/)
